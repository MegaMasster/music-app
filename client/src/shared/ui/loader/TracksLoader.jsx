import useTracksListPopupStore from "../../stores/useTracksListPopupStore"
            ...
            {tracksLoading && (
                <div className="flex items-center justify-center w-full h-full min-h-[100px]">
                    <div className="relative flex items-center justify-center">
                        ...
                        <div className="flex items-end gap-[3px] h-8 relative z-10">
                        {[
                            { h: '60%', d: '0.1s' },
                            { h: '100%', d: '0.3s' },
                            { h: '70%', d: '0.5s' },
                            ...
                            <div
                            key={i}
                            className="w-[3px] bg-blue-500 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.5)]"
                            style={{
                                height: bar.h,
