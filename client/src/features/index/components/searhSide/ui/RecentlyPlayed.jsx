...
const RecentlyPlayed = () => {
    ...
    return (
        <section className="relative z-10 w-full min-h-[270px] sm:min-h-[255px]">  
            ...
            {userTracks.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-18 md:py-15 px-4 rounded-4xl border border-dashed border-white/5 bg-white/[0.01]">
